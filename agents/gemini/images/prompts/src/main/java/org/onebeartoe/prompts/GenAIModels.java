...
public enum GenAIModels 
{
    ...
    GEMINI_2_5_FLASH("gemini-2.5-flash", "Gemini 2.5 Flash", "Price-performance balance, low-latency, high-volume tasks."),
    
    GEMINI_2_5_FLASH_IMAGE("gemini-2.5-flash-image", "Gemini 2.5 Flash Image", "Price-performance balance, low-latency, high-volume tasks for images."),
