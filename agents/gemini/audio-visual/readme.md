...
I used the [REDUCE_FILESIZE_BUT_NOT_QUALITY](../images/prompts/src/main/java/org/onebeartoe/prompts/Prompts.java) to reduce the size of the file, for upload to Github.
